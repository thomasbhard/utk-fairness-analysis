...
dataset_folder_name = r'C:\Users\thoma\Documents\_FAIRALGOS\utk-fairness-analysis\dataset\UTKFace'
outputdir_name = time.strftime("%Y%m%d-%H%M%S", time.gmtime(time.time()))
outputdir_path = os.path.join(r'C:\Users\thoma\Documents\_FAIRALGOS\utk-fairness-analysis\models', outputdir_name)
